// EmployeeQueryPage.js

import React, { useState, useEffect, useRef } from "react";
import { Menu, User, Send, Smile, Plus, Mic } from "lucide-react";
import { setDoc, doc, collection, getDocs, serverTimestamp, addDoc } from "firebase/firestore";
...
const EmployeeQueryPage = () => {
  ...
  const toggleSmileMenu = () => setShowSmileMenu((prevState) => !prevState);
  const toggleMenu = () => setShowMenu(!showMenu);
  const clearChat = () => setMessageHistory([]);
  const logOut = () => {
    signOut(auth)
      .then(() => {
